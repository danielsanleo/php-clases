                  ...
                  <tr>
                    <td class="bordeLateral" bgcolor="#FFFFFF">
                        <table width="910" border="0" align="center" cellpadding="4" cellspacing="0" bgcolor="#FFFFFF" class="bordeExterior">
                          <tr>
                            <td width="2"><div align="right"><a href="javascript:window.history.back();"><img src="images/icono-volver.png" alt="Volver" title="Volver" width="16" height="16" border="0" /></a></div></td>
                            <td width="40"><a href="javascript:window.history.back();" class="enlace">atr&aacute;s</a></td>
                            <td width="2"><div align="right"><a href="menu.php?action=soporte"><img src="images/icono-soporte.png" alt="Soporte tecnico" title="Soporte" width="16" height="16" border="0" /></a></div></td>
